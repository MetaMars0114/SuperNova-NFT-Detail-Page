    ...
    <div style={{ marginTop: "-20px" }}>
      ...
      >
        <Grid item container justify="center" style={{ maxWidth: "95vw" }}>
          ...
          >
            <p
              style={{ fontSize: "12pt", fontWeight: "bold", lineHeight: ".7" }}
            >
              Status
            </p>
            <p
              style={{ fontSize: "24pt", fontWeight: "bold", lineHeight: ".7" }}
            >
              Active
            </p>
          </div>
          ...
          {syncing && (
            ...
            >
              ...
              {typeof syncing === "object" && syncing.currentBlock && (
                <p style={{ fontSize: "24pt", fontWeight: "bold" }}>
      ...
      >
        <p style={{ lineHeight: ".2" }}>
          <b>Nova Network Block Explorer</b>
        </p>
